...
final class Version20260703120000 extends AbstractMigration
{
    ...
    {
        // Table de liaison many-to-many : un chat peut travailler dans plusieurs salons
        $this->addSql('
        ...
        // On copie les anciennes données avant de supprimer location_id sur cat
        $this->addSql('
        ...
        // Chaque profil chat peut être lié à un compte utilisateur (ROLE_CAT)
